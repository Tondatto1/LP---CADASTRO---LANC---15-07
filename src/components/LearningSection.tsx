...
export default function LearningSection() {
  ...
  return (
    <section id="modulos" className="relative py-24 px-6 bg-gradient-to-b from-[#050505] via-[#021812] to-[#020710] overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-[#020710] via-[#020710]/60 to-transparent pointer-events-none z-10" />
